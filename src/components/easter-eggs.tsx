...
const EasterEggs = () => {
  ...
  useEffect(() => {
    ...
    if (typeof console !== "undefined") {
      ...
      ["navruz", "Navruz", "NAVRUZ", "ergashev", "Ergashev"].forEach((name) => {
        // @ts-ignore
        ...
        Object.defineProperty(window, name, {
          get() {
            console.log(
              "%c✨ Abra Kadabra! ✨\n\n" +
                "You just summoned the magic of Ergashev Navruz! 🧙‍♂️\n" +
                "Frontend Developer & UI Engineer ready to create stunning web experiences! 💻⚡",

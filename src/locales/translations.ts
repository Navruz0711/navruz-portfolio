  ...
  uz: {
    ...
    experience: {
      ...
      stats: {
        ...
        orders: { label: "Buyurtmalar", value: "48", sub: "Muvaffaqiyatli bajarilgan" },
        reviews: { label: "Taqrizlar", value: "36", sub: "100% ijobiy fikrlar" },
        success: { label: "Muvaffaqiyat", value: "98%", sub: "Topshirilgan buyurtmalar" },
        onTime: { label: "Vaqtida", value: "85%", sub: "O'z vaqtida topshirilgan" },
        repeat: { label: "Doimiy", value: "38%", sub: "Qayta buyurtmalar" },
      },
      items: [
        {
          id: 1,
          ...
          description: [
            "Kwork frilans platformasida «Продавец с высшим рейтингом» darajasi — 48 ta buyurtma muvaffaqiyatli topshirilgan va 36 ta ijobiy taqriz olingan.",
            "98% buyurtmalar a'lo darajada topshirilgan, 85% o'z vaqtida topshirilgan, 38% mijozlar qayta buyurtma bergan.",
    ...
    blog: {
      ...
      posts: {
        ...
        "freelance-engineering-insights": {
          title: "Oliy reytingli frilanser sifatida 48 dan ortiq loyihalarni topshirishdan olingan xulosalar",
      ...
      perks: {
        ...
        items: [
          ...
          },
          {
            ...
            description: "48 dan ortiq tijoriy loyihalar asosidagi real keyslar, mijozlar bilan ishlash va natijaga erishish sirlari.",
          },
        ],
      },
      archive: {
        ...
        items: [
          ...
          },
          {
            id: "issue-01",
            number: "01-Nashr",
            title: "Oliy Reytingli Frilanser Qo'llanmasi: 48+ Buyurtma va 98% Natija",
            date: "Avgust 2024",
            readTime: "7 daqiqa",
            ...
            highlights: [
              ...
              "85% muddatida topshirish ko'rsatkichini saqlab qolish sirlari",
            ],
          },
        ],
      },
  ...
  ru: {
    ...
    experience: {
      ...
      stats: {
        ...
        orders: { label: "Заказы", value: "48", sub: "Выполнено успешно" },
        reviews: { label: "Отзывы", value: "36", sub: "100% положительные" },
        success: { label: "Успешность", value: "98%", sub: "Заказов успешно сдано" },
        onTime: { label: "Пунктуальность", value: "85%", sub: "Сдано вовремя" },
        repeat: { label: "Повторные", value: "38%", sub: "Постоянные клиенты" },
      },
      items: [
        {
          id: 1,
          ...
          description: [
            "Продавец с высшим рейтингом на платформе Kwork — 48 успешно выполненных заказов и 36 положительных отзыва.",
            "98% заказов успешно сдано, 85% сдано точно в срок, 38% клиентов обращаются повторно.",
    ...
    blog: {
      ...
      posts: {
        ...
        "freelance-engineering-insights": {
          title: "Уроки сдачи более 48 коммерческих проектов в статусе продавца с высшим рейтингом",
      ...
      perks: {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Реальные кейсы из более чем 48 коммерческих проектов, работа с клиентами и секреты высокого рейтинга.",
          },
        ],
      },
      archive: {
        ...
        items: [
          ...
          },
          {
            id: "issue-01",
            number: "Выпуск #01",
            title: "Гайд продавца с высшим рейтингом: 48+ проектов и 98% успеха",
            date: "Август 2024",
            readTime: "7 мин",
            ...
            highlights: [
              ...
              "Соблюдение сроков для достижения 85% своевременной сдачи",
            ],
          },
        ],
      },
  ...
  en: {
    ...
    experience: {
      ...
      stats: {
        ...
        orders: { label: "Orders", value: "48", sub: "Successfully completed" },
        reviews: { label: "Reviews", value: "36", sub: "100% positive feedback" },
        success: { label: "Success Rate", value: "98%", sub: "Orders delivered successfully" },
        onTime: { label: "On-Time", value: "85%", sub: "Delivered on schedule" },
        repeat: { label: "Repeat", value: "38%", sub: "Returning clients" },
      },
      items: [
        {
          id: 1,
          ...
          description: [
            "Top-rated seller on Kwork platform with 48 completed orders and 36 five-star reviews.",
            "98% successful order completion rate, 85% on-time delivery, and 38% repeat client rate.",
    ...
    blog: {
      ...
      posts: {
        ...
        "freelance-engineering-insights": {
          title: "Lessons from Delivering 48+ Production Web Projects as a Top-Rated Freelancer",
      ...
      perks: {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Real-world case studies, client delivery insights, and workflows from over 48+ commercial projects.",
          },
        ],
      },
      archive: {
        ...
        items: [
          ...
          },
          {
            id: "issue-01",
            number: "Issue #01",
            title: "The Top-Rated Freelance Playbook: 48+ Projects & 98% Success",
            date: "Aug 2024",
            readTime: "7 min read",
            ...
            highlights: [
              ...
              "Managing deadlines to achieve 85% on-time delivery",
            ],
          },
        ],
      },
